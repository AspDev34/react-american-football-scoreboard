...
const [countHome, setHome] = useState(0); // first value is a variable holding the value, the second modifies that variable.
const [countAway, setAway] = useState(0); // useState sets the initial value. In this case both teams start with 0 points.
const homeTouchdown = () => setHome (countHome + 7);
const awayTouchdown = () => setAway (countAway + 7);
const homeFG = () => setHome (countHome+ 3);
const awayFG = () => setAway (countAway + 3);
